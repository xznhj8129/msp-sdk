// Consolidated INAV defines. Generated; do not edit.
...
#define NAV_THROTTLE_CUTOFF_FREQENCY_HZ     4.0f
...
// ../inav/src/main/sensors/battery_sensor_crsf.c
...
#ifdef USE_PITOT
#define PITOT_FAILURE_THRESHOLD 10
#define PITOT_RECOVERY_THRESHOLD 100
...
// ../inav/src/main/io/crsf_sensor.c
...
#define UBX_HW_SERIES_UBLOX_NM      0x40
#define UBX_HW_VERSION_UNKNOWN      0
#define UBX_HW_VERSION_UBLOX5       (UBX_HW_SERIES_UBLOX_NM | 5)
#define UBX_HW_VERSION_UBLOX6       (UBX_HW_SERIES_UBLOX_NM | 6)
#define UBX_HW_VERSION_UBLOX7       (UBX_HW_SERIES_UBLOX_NM | 7)
#define UBX_HW_VERSION_UBLOX8       (UBX_HW_SERIES_UBLOX_NM | 8)
#define UBX_HW_VERSION_UBLOX9       (UBX_HW_SERIES_UBLOX_NM | 9)
#define UBX_HW_VERSION_UBLOX10      (UBX_HW_SERIES_UBLOX_NM | 10)
...
#define SERVO_AUTOTRIM_FILTER_CUTOFF    1.0f
...
#define SERVO_AUTOTRIM_ITERM_RATE_LIMIT 30
...
#ifdef USE_SIMULATOR
#define SIMULATOR_MSP_VERSION_2  2
...
// ../inav/src/main/drivers/accgyro/accgyro_icm45686.c
...
#define ICM456XX_GYRO_MODE_LP                   (0x02 << 2)
#define ICM456XX_GYRO_MODE_LN                   (0x03 << 2)
#define ICM456XX_ACCEL_MODE_OFF                 (0x00)
#define ICM456XX_ACCEL_MODE_OFF2                (0x01)
#define ICM456XX_ACCEL_MODE_LP                  (0x02)
#define ICM456XX_ACCEL_MODE_LN                  (0x03)
...
#define ICM456XX_RESET_TIMEOUT_US               20000
...
#define ICM456XX_SRC_CTRL_AAF_ENABLE_BIT        (1 << 0)
#define ICM456XX_SRC_CTRL_INTERP_ENABLE_BIT     (1 << 1)
#define ICM456XX_ACCEL_SRC_CTRL_IREG_ADDR       0xA57B
#define ICM456XX_GYRO_SRC_CTRL_IREG_ADDR        0xA4A6
#define ICM456XX_REG_IREG_ADDR_15_8             0x7C
#define ICM456XX_REG_IREG_ADDR_7_0              0x7D
#define ICM456XX_REG_IREG_DATA                  0x7E
#define ICM456XX_GYRO_UI_LPF_CFG_IREG_ADDR       0xA4AC
...
#define ICM456XX_ACCEL_UI_LPF_CFG_IREG_ADDR      0xA583
...
#define ICM456XX_ACCEL_STARTUP_TIME_MS          10
#define ICM456XX_GYRO_STARTUP_TIME_MS           35
#define ICM456XX_SENSOR_ENABLE_DELAY_MS         1
#define ICM456XX_INT_CONFIG_DELAY_MS            15
#define ICM456XX_IREG_TIMEOUT_US                5000
#define ICM456XX_DATA_LENGTH                    6
#define ICM456XX_SPI_BUFFER_SIZE                (1 + ICM456XX_DATA_LENGTH)
#endif
...
// ../inav/src/main/drivers/barometer/barometer_crsf.c
...
// ../inav/src/main/drivers/bus_spi_stm32f7xx.h
#define SPI_PIN_AF_HELPER(spi, pin)  CONCAT4(SPI_PIN_AF_SPI, spi, _, pin)
#define SPI_PIN_AF_SPI1_PA5    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PA6    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PA7    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PB3    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PB4    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PB5    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI2_PB13   GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PB14   GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PB15   GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PC1    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PC2    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PC3    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI3_PB2    GPIO_AF7_SPI3
#define SPI_PIN_AF_SPI3_PB3    GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PB4    GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PB5    GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PC10   GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PC11   GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PC12   GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PD6    GPIO_AF5_SPI3
#define SPI_PIN_AF_SPI4_PE2    GPIO_AF5_SPI4
#define SPI_PIN_AF_SPI4_PE5    GPIO_AF5_SPI4
#define SPI_PIN_AF_SPI4_PE6    GPIO_AF5_SPI4
#define SPI_PIN_AF_SPI4_PE12   GPIO_AF5_SPI4
#define SPI_PIN_AF_SPI4_PE13   GPIO_AF5_SPI4
#define SPI_PIN_AF_SPI4_PE14   GPIO_AF5_SPI4


// ../inav/src/main/drivers/bus_spi_stm32h7xx.h
#define SPI_PIN_AF_HELPER(spi, pin)  CONCAT4(SPI_PIN_AF_SPI, spi, _, pin)
#define SPI_PIN_AF_SPI1_PA5    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PA6    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PA7    GPIO_AF5_SPI1
...
#define SPI_PIN_AF_SPI1_PB4    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PB5    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI1_PD7    GPIO_AF5_SPI1
#define SPI_PIN_AF_SPI2_PA9    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PB10   GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PB13   GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PB14   GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PB15   GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PC1    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PC2    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PC3    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI2_PD3    GPIO_AF5_SPI2
#define SPI_PIN_AF_SPI3_PB2    GPIO_AF7_SPI3
#define SPI_PIN_AF_SPI3_PB3    GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PB4    GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PB5    GPIO_AF7_SPI3
#define SPI_PIN_AF_SPI3_PC10   GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PC11   GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PC12   GPIO_AF6_SPI3
#define SPI_PIN_AF_SPI3_PD6    GPIO_AF5_SPI3
...
// ../inav/src/main/drivers/dronecan/libcanard/canard.c
#define MIN(a, b)   (((a) < (b)) ? (a) : (b))
#define MAX(a, b)   (((a) > (b)) ? (a) : (b))
...
// ../inav/src/main/drivers/dronecan/libcanard/canard.h
#ifndef CANARD_H
#define CANARD_H
...
// ../inav/src/main/drivers/dronecan/libcanard/canard_internals.h
...
// ../inav/src/main/drivers/dronecan/libcanard/canard_stm32_driver.h
...
// ../inav/src/main/drivers/pitotmeter/pitotmeter_ms5525.c
...
// ../inav/src/main/drivers/pwm_mapping.c
#if !defined(SITL_BUILD)
